...
void strlen_mve(int LANE_NUM,
    ...
    char value = '\0';
    const __uint8_t **src_addr = (const __uint8_t **)strlen_input->src_addr;
    ...
    if (min_idx != 10000000)
        strlen_output->return_value[0] = min_idx;
    else
        strlen_output->return_value = nullptr;
}